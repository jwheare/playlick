    ...
    playlists: {
        'test': {
            ...
            tracks: [
                ...
                new MODELS.Track('Stay Loose', 'Belle and Sebastian', (6*60)+42),
                new MODELS.Track('Such Great Heights', 'The Postal Service', (4*60)+26),
                new MODELS.Track('Stockholm Syndrome', 'Muse', (4*60)+57),
                new MODELS.Track('New Slang', 'The Shins', (3*60)+52),
                new MODELS.Track('Bluebird', 'Devendra Banhart', (1*60)+28),
                new MODELS.Track('Von', 'Sigur Rós', (8*60)+14),

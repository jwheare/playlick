...
var STRINGS = {
    ...
    playdar_unavailable_text: '<a href="http://www.playdar.org/">Playdar unavailable</a>. <a href="#" onclick="$(\'#playdar\').html(STRINGS.loading_playdar_text); Playdar.client.init(); return false;">retry</a>',
